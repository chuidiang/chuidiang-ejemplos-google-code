...
public class CapaWMS {
   ...
   public void anadeUrl(String url, WorldWindowGLCanvas wwd, LayerPanel panelCapas ){
      try {
      WMSCapabilities capabilities = WMSCapabilities.retrieve(new URI(url));
      capabilities.parse();
      List<WMSLayerCapabilities> listaCapacidadesCapa = capabilities.getNamedLayers();
...
//         params.setValue("transparent", "true");
